...
t_end = 3600 * 100
if bg_exist == 1:
    arrival_output_path = 'traffic_outputs/with_bg_no_others/t_stats/arrivals_{}_bg_1_real_departure_time.csv'.format(scenario_name)
else:
    arrival_output_path = 'traffic_outputs/no_bg/t_stats/arrivals_{}_bg_1_real_departure_time.csv'.format(scenario_name)
...
for t in range(t_end):
    ...
    if t%1000 == 0:
        if not arrival_counts_vect(t, simulation_vect, arrival_output_path):
            break
        if bg_exist == 1:
            link_output_path = 'traffic_outputs/with_bg_no_others/link_stats/l{}_at_{}_bg_1_real_departure_time.csv'.format(scenario_name, t)
            agent_output_path = 'traffic_outputs/with_bg_no_others/agent_stats/{}_at_{}_bg_1_agent_real_departure_time.csv'.format(scenario_name, t)
        else:
