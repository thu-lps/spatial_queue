...
class Network:
    ...
    def prepare_links(self, links_df, virtual_nodes_df):
        ...
        self.links = self.links[['link_id', 'start_node_id', 'end_node_id', 'link_type', 'length', 'lanes', 'maxmph', 'fft', 'capacity', 'storage', 'geometry','sequence','storage_add_times']]
    ...
    def run_link_model(self, agents=None, t=None):
        ...
        self.links['storage_add_times'] = np.where(self.links['sequence'].isin(position), self.links['storage_add_times']+1, self.links['storage_add_times']) 
