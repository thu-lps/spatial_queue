...
class Network:
    ...
    def prepare_links(self, links_df, virtual_nodes_df):
        ...
        self.links = self.links[['link_id', 'start_node_id', 'end_node_id', 'link_type', 'length', 'lanes', 'maxmph', 'fft', 'capacity', 'storage', 'geometry','storage_add_times']]
    ...
    def reroutes(self, network=None, t=None, reroute_frequency=None):
        ...
        if reroute_frequency is None:
            ...
            if (t >=1) & (t%reroute_frequency == 0):
                ### staggered rerouting
                reroute_agents = self.agents[(self.agents['agent_status'].isin([1, 2]))].sample(frac=0.2)
...
class Simulation():
    ...
    def initialize_simulation(self, nodes_df, links_df, ods_df,seed_num):
