...
t_end = 3600 * 20
if bg_exist == 1:
    arrival_output_path = 'traffic_outputs/{}/with_bg/t_stats_add_srsn/arrivals_{}_bg_1_real_departure_time_total.csv'.format(case, scenario_name)
    arrival_output_path_1 = 'traffic_outputs/{}/with_bg/t_stats_add_srsn/arrivals_{}_bg_1_real_departure_time_evacuation.csv'.format(case, scenario_name)
else:
    arrival_output_path = 'traffic_outputs/{}/no_bg/t_stats_add_srsn/arrivals_{}_bg_1_real_departure_time.csv'.format(case, scenario_name)
...
for t in range(t_end):
    ...
    if t%100 == 0:
        if bg_exist == 1:
            link_output_path = 'traffic_outputs/{}/with_bg/link_stats_add_srsn/l{}_at_{}_bg_1_real_departure_time.csv'.format(case, scenario_name, t)
            agent_output_path = 'traffic_outputs/{}/with_bg/agent_stats_add_srsn/{}_at_{}_bg_1_real_departure_time_agent.csv'.format(case, scenario_name, t)
        else:
            link_output_path = 'traffic_outputs/{}/no_bg/link_stats_add_srsn/l{}_at_{}_bg_1_real_departure_time.csv'.format(case, scenario_name, t)
