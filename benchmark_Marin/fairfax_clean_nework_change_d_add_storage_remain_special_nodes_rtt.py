...
t_end = 3600 * 20
if bg_exist == 1:
    arrival_output_path = 'traffic_outputs/{}/with_bg/t_stats_add_srsn_rtt/arrivals_{}_bg_1_real_departure_time_total.csv'.format(case, scenario_name)
    arrival_output_path_1 = 'traffic_outputs/{}/with_bg/t_stats_add_srsn_rtt/arrivals_{}_bg_1_real_departure_time_evacuation.csv'.format(case, scenario_name)
else:
    arrival_output_path = 'traffic_outputs/{}/no_bg/t_stats_add_srsn_rtt/arrivals_{}_bg_1_real_departure_time.csv'.format(case, scenario_name)
...
for t in range(t_end):
    ...
    if t%100 == 0:
        if bg_exist == 1:
            link_output_path = 'traffic_outputs/{}/with_bg/link_stats_add_srsn_rtt/l{}_at_{}_bg_1_real_departure_time.csv'.format(case, scenario_name, t)
            agent_output_path = 'traffic_outputs/{}/with_bg/agent_stats_add_srsn_rtt/{}_at_{}_bg_1_real_departure_time_agent.csv'.format(case, scenario_name, t)
    ...
    if t%100 == 0:
        if not arrival_counts_vect(t, simulation_vect, arrival_output_path,arrival_output_path_1):
            write_loops(simulation_vect, 'traffic_outputs/{}/with_bg/loop_add_srsn/loops_add_srsn_rtt.xlsx'.format(case))
            write_all_link_outputs_vect(simulation_vect, 'traffic_outputs/{}/with_bg/link_stats_add_srsn_rtt/l{}_at_{}_all_links.csv'.format(case, scenario_name, t))
            break
