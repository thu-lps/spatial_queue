...
od_df['departure_time'] = od_df['departure_time'].apply(lambda x: x*10) # departure interval is 10 seconds
...
if bg_exist == 1:
    ...
    arrival_output_path = 'traffic_outputs/{}/no_bg/t_stats_final/arrivals_{}_bg_0_total.csv'.format(case, scenario_name)
    arrival_output_path_1 = 'traffic_outputs/{}/no_bg/t_stats_final/arrivals_{}_bg_0_evacuation.csv'.format(case, scenario_name)
...
for t in range(t_end):
    ...
    if t%100 == 0:
        if bg_exist == 1:
            ...
            link_output_path = 'traffic_outputs/{}/no_bg/link_stats_final/l{}_at_{}_bg_0.csv'.format(case, scenario_name, t)
            agent_output_path = 'traffic_outputs/{}/no_bg/agent_stats_final/{}_at_{}_bg_0_agent.csv'.format(case, scenario_name, t)          
    ...
    if t%100 == 0:
        if not arrival_counts_vect(t, simulation_vect, arrival_output_path,arrival_output_path_1):
            if bg_exist == 1:
                ...
                write_loops(simulation_vect, 'traffic_outputs/{}/no_bg/loop_final/loops.xlsx'.format(case))
