...
links_df.loc[links_df['link_id'].isin([5833, 4402, 38005, 13318, 4834, 2940, 4849, 1247, 17681, 15372]), 'lanes'] += 1
...
arrival_output_path = 'traffic_outputs/{}/sensitivity_analysis/t_stats_add_srsn_widen_Route5/arrivals_{}_bg_1_real_departure_time_total.csv'.format(case, scenario_name)
arrival_output_path_1 = 'traffic_outputs/{}/sensitivity_analysis/t_stats_add_srsn_widen_Route5/arrivals_{}_bg_1_real_departure_time_evacuation.csv'.format(case, scenario_name)
...
for t in range(t_end):
    ...
    if t%100 == 0:
        link_output_path = 'traffic_outputs/{}/sensitivity_analysis/link_stats_add_srsn_widen_Route5/l{}_at_{}_bg_1_real_departure_time.csv'.format(case, scenario_name, t)
        agent_output_path = 'traffic_outputs/{}/sensitivity_analysis/agent_stats_add_srsn_widen_Route5/{}_at_{}_bg_1_real_departure_time_agent.csv'.format(case, scenario_name, t)
    ...
    if t%100 == 0:
        if not arrival_counts_vect(t, simulation_vect, arrival_output_path,arrival_output_path_1):
            write_loops(simulation_vect, 'traffic_outputs/{}/sensitivity_analysis/loop_add_srsn_widen_Route5/loop_add_srsn.xlsx'.format(case))
            #write_all_link_outputs_vect(simulation_vect, 'traffic_outputs/{}/with_bg/link_stats_add_srsn_widen_Route5/l{}_at_{}_all_links.csv'.format(case, scenario_name, t))
            break
