...
nodes_df = pd.read_csv('traffic_inputs/{}/new_{}_nodes.csv'.format(case,case), float_precision = "round_trip")
links_df = pd.read_csv('traffic_inputs/{}/new_{}_links.csv'.format(case,case), float_precision = "round_trip")
od_df = pd.read_csv('traffic_inputs/{}/{}_ods_day_new.csv'.format(case,case), float_precision = "round_trip")
