...
case='fairfax'
bg_exist = 0 # 1 represents bg exists, 0 represents bg does not exist
...
if bg_exist == 1:
    ...
    arrival_output_path = 'traffic_outputs/{}/no_bg/t_stats/arrivals_{}_no_bg.csv'.format(case, scenario_name)
...
for t in range(t_end):
    ...
    if t%1000 == 0:
        ...
        if bg_exist == 1:
            ...
            link_output_path = 'traffic_outputs/{}/no_bg/link_stats/l{}_at_{}_no_bg.csv'.format(case, scenario_name, t)
