...
import model.spatial_queue_array_edited_add_reroute_func_and_rtt as sq_vect
...
t_end = 3600 * 35
if bg_exist == 1:
    arrival_output_path = 'traffic_outputs/{}/with_bg/t_stats_rtt/arrivals_{}_bg_1_real_departure_time_total.csv'.format(case, scenario_name)
    arrival_output_path_1 = 'traffic_outputs/{}/with_bg/t_stats_rtt/arrivals_{}_bg_1_real_departure_time_evacuation.csv'.format(case, scenario_name)
else:
    arrival_output_path = 'traffic_outputs/{}/no_bg/t_stats_rtt/arrivals_{}_bg_1_real_departure_time.csv'.format(case, scenario_name)
...
for t in range(t_end):
    ...
    if t%100 == 0:
        if not arrival_counts_vect(t, simulation_vect, arrival_output_path,arrival_output_path_1):
            break
        link_output_path = 'traffic_outputs/{}/with_bg/link_stats_rtt/l{}_at_{}_bg_1_real_departure_time.csv'.format(case, scenario_name, t)
        agent_output_path = 'traffic_outputs/{}/with_bg/agent_stats_rtt/{}_at_{}_bg_1_real_departure_time_agent.csv'.format(case, scenario_name, t)
