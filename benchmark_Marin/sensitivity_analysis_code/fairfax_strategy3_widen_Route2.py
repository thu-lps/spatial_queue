...
links_df.loc[links_df['link_id'].isin([1420, 21240, 23002, 12176, 58]), 'lanes'] += 1
...
arrival_output_path = 'traffic_outputs/{}/sensitivity_analysis/t_stats_widen_Route2/arrivals_{}_bg_1_real_departure_time_total.csv'.format(case, scenario_name)
arrival_output_path_1 = 'traffic_outputs/{}/sensitivity_analysis/t_stats_widen_Route2/arrivals_{}_bg_1_real_departure_time_evacuation.csv'.format(case, scenario_name)
...
for t in range(t_end):
    ...
    if t%100 == 0:
        if bg_exist == 1:
            link_output_path = 'traffic_outputs/{}/sensitivity_analysis/link_stats_widen_Route2/l{}_at_{}_bg_1_real_departure_time.csv'.format(case, scenario_name, t)
            agent_output_path = 'traffic_outputs/{}/sensitivity_analysis/agent_stats_widen_Route2/{}_at_{}_bg_1_real_departure_time_agent.csv'.format(case, scenario_name, t)
    ...
    if t%100 == 0:
        if not arrival_counts_vect(t, simulation_vect, arrival_output_path,arrival_output_path_1):
            write_loops(simulation_vect, 'traffic_outputs/{}/sensitivity_analysis/loop_widen_Route2/loops_add_srsn_reroute_rtt.xlsx'.format(case))
            break
